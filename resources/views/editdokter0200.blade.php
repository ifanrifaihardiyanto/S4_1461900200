                ...
                <div class="container mt-n10">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <br>
                            <form method="POST" action="{{ url('dokter/'. $dataDokter->id) }}">
                                @csrf
                                <input type="hidden" name="_method" value="patch">
                                <div class="form-group">
                                    <label for="nama_dokter">Nama Dokter</label>
                                    <input type="text" class="form-control"
                                        name="nama_dokter" id="nama_dokter" value="{{ $dataDokter->nama }}">
                                </div>
                                <div class="form-group">
                                    <label for="jabatan_dokter">Jabatan Dokter</label>
                                    <input type="text" class="form-control"
                                        name="jabatan_dokter" id="jabatan_dokter" value="{{ $dataDokter->jabatan }}">
                                </div>
                                <div class="form-group">
